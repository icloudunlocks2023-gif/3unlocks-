...
export const initialNotifications: NotificationItem[] = [
  {
    ...
    description: 'Server upgraded to v1.6. Added support for iPad Air & iPhone 14 series iOS 17.5+ activation bypass.',
    time: '2 hours ago',
    read: false,
    type: 'server',
  },
  ...
  },
  {
    ...
    description: 'Your customized bypass restore IPSW signature firmware is compiled and ready for download!',
    time: '4 hours ago',
    read: false,
    type: 'order',
  },
